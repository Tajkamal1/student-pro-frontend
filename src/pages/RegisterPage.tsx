...
import {
  ...
  CheckCircle2, CalendarCheck, BarChart3, Clock,
} from "lucide-react";
    ...
    <div className="flex min-h-screen w-full">
      ...
      >
        <div className="max-w-md">
          ...
          <h2 className="mb-4 font-display text-4xl font-bold">Start Your Journey</h2>
          <p className="mb-10 text-lg text-white/70">
            Create your free account and unlock the full potential of your academic life.
          </p>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <h2 className="mb-2 font-display text-3xl font-bold text-foreground">Create Account</h2>
          <p className="mb-8 text-muted-foreground">Get started with your free account</p>
